...
const TRANSLATIONS = {
  'en': {
    ...
    'hero.subtitle':      'Semantic compression proxy daemon for Claude Code. Reduces tool output by <strong>70–99%</strong> before it reaches the LLM context — using three progressive compression layers with optional local neural inference.',
    ...
    'how.l4_desc':  "Passes Claude's current intent to the model for context-aware compression. Optional.",
    ...
    'cmd.init_hook_only': 'Install hook script only — skip config.json creation and model setup wizard.',
  ...
  'pt': {
    ...
    'hero.title1':        'Neural',
    'hero.title2':        'Token Killer',
    'hero.subtitle':      'Proxy de compressão semântica para o Claude Code. Reduz a saída das ferramentas em <strong>70–99%</strong> antes de chegar ao contexto do LLM — usando três camadas progressivas com inferência neural local opcional.',
    ...
    'how.l4_desc':  'Passa a intenção atual do Claude para o modelo para compressão contextual. Opcional.',
    ...
    'cmd.init_hook_only': 'Instala apenas o script do hook — ignora criação do config.json e wizard de modelo.',
