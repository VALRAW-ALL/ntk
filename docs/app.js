...
const TRANSLATIONS = {
  'en': {
    ...
    'gs.step2_note':  '<strong>Note:</strong> the <code style="font-family:var(--font-mono)">cuda</code> feature requires the CUDA Toolkit (<code style="font-family:var(--font-mono)">nvcc</code> on PATH). Cargo does not ship SDKs. There is no AMD feature flag; AMD users build the CPU variant and configure a Vulkan <code style="font-family:var(--font-mono)">llama-server</code> via <code style="font-family:var(--font-mono)">ntk model setup</code>.',
  ...
  'pt': {
    ...
    'gs.step2_note':  '<strong>Observação:</strong> a feature <code style="font-family:var(--font-mono)">cuda</code> exige o CUDA Toolkit (<code style="font-family:var(--font-mono)">nvcc</code> no PATH). O Cargo não instala SDKs. Não existe flag para AMD; usuários AMD compilam a variante CPU e configuram um <code style="font-family:var(--font-mono)">llama-server</code> com Vulkan via <code style="font-family:var(--font-mono)">ntk model setup</code>.',
